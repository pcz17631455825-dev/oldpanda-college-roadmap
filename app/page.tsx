  ...
  return (
    <main className="education-home">
      ...
      <section className="education-hero">
        ...
        <figure className="education-portrait">
      ...
      <section className="education-routes" aria-label="三条大学发展路线">
        ...
        <article><b>升学</b><p>在课程、科研与长期能力里，为更高的平台蓄力。</p></article>
        <article><b>体制</b><p>把政策理解、岗位机会与基本功，变成稳妥选择。</p></article>
        <article><b>就业</b><p>用项目、实习与作品，让能力更早进入真实世界。</p></article>
      </section>
      <section id="resources" className="education-resources">
        <div><p>老熊猫资料驿站</p><h2>把有用的大学经验，留给真正需要的你。</h2><span>新生适应、选课规划、升学准备、求职与体制内规划资料会陆续更新，做成能下载、能反复使用的行动清单。</span></div>
        <img src="/panda/avatar.png" alt="老熊猫头像" />
      </section>
